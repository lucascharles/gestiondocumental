<? 	include("views/cabecera.php"); 
	...
	$titulo_form = "ADMINISTRAR DISPOSITIVO";
    ...
    <tr>
    	<td colspan="3">
        	<table width="100%" border="0" cellpadding="0" cellspacing="3" align="center" id="buscador">
		        <tr>
                	<td colspan="1" align="right" width="50"  class="etiqueta_form">Descripci&oacute;n&nbsp;</td>
					<td colspan="1" align="left" width="200"  class="etiqueta_form"><input type="text" name="descripcion" id="descripcion"  filtro="S" value="<? echo($_SESSION["f_descripcion"]) ?>"  class="input_form_largo" onFocus="resaltar(this)" onBlur="noresaltar(this)"  onkeyup='mostrar()' tabindex="0"/>
                    
                    </td>
                    <td colspan="1" align="left" class="etiqueta_form">Tipo&nbsp;
                     <select name="id_tipo_dispositivo" filtro="S" id="id_tipo_dispositivo" class="input_form" onFocus="resaltar(this)" onBlur="noresaltar(this)" onchange="mostrar()">	
                    <option value="">Todas los tipos</option>
                    <?
                    for($i=0; $i<$col_tipo_dispositivo->get_count(); $i++)
					{
						$dtmp = &$col_tipo_dispositivo->items[$i];
						$selected = "";
						if($dtmp->get_data("id") == $_SESSION["f_id_tipo_dispositivo"])
						{
                    ...
                    &nbsp;&nbsp;
                    Estado&nbsp;
                     <select name="id_estado_dispositivo" filtro="S" id="id_estado_dispositivo" class="input_form_largo" onFocus="resaltar(this)" onBlur="noresaltar(this)" onchange="mostrar()">	
                    <option value="">Todas los estados</option>
                    <?
                    for($i=0; $i<$col_estado_dispositivo->get_count(); $i++)
					{
						$dtmp = &$col_estado_dispositivo->items[$i];
						$selected = "";
                    ...
                    <td colspan="1" align="left" class="etiqueta_form">
                    </td>
			    </tr>
                ...
                <tr>
                    ...
                    <table class="opciones" onclick="nuevoRegistro('<?=$controller?>')" title="Nuevo Dispositivo" style="<?=$display_a?>">
                        <tr>
