...
$titulo_form = "Prevension de Riesgos";
$id= $ctrIdContratista;
...
?>
<form name="frmprevensionriesgos" action="" method='post'>
...
<table  align="center" border="0" width="80%" cellpadding="0" cellspacing="0" id="formulario">
	...
	<tr>
       	<td align="left" colspan="3" class="etiqueta_form">Agencia:&nbsp;<?=$dato["ctrNombreFantasia"]?></td>
   </tr>    
	<tr>
       	<td align="left" colspan="3" class="etiqueta_form">Encargado:&nbsp;<?=$dato["ctrNombreExpertoMutualidad"]?></td>
   </tr>    
