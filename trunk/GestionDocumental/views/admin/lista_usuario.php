...
<table width="100%" cellpadding="0" cellspacing="0" align="center" border="0" bgcolor="#FFFFFF" id="listado">
	...
	<tr bgcolor="#FFFFFF" id="fila_<?php echo ($datoTmp->get_data("id")) ?>">
        ...
        <td align="left" width="10%"><?php echo ($datoTmp->get_data("id_usuario")) ?></td>
		<td align="left" width="30%"><?php echo (utf8_decode($datoTmp->get_data("nom_usuario"))) ?></td>
        <td align="left" width="30%"><?php echo (utf8_decode($datoTmp->get_data("ape_usuario"))) ?></td>
