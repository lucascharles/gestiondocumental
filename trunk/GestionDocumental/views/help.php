<table  border="0" cellpadding="0" cellspacing="0" align="right" id="leyendas" style="background-color:#FFFFFF; border:solid; border-width:1px; border-radius:3px; border-color:#C0DECF; margin-right:13px; -moz-box-shadow: 1px 1px 3px #ccc; -webkit-box-shadow: 1px 1px 3px #ccc; box-shadow: 1px 1px 3px #ccc;	/* IE 8 */ -ms-filter: "progid:DXImageTransform.Microsoft.Shadow(Strength=4, Direction=135, Color='#cccccc')";	filter: progid:DXImageTransform.Microsoft.Shadow(Strength=4, Direction=135, Color='#cccccc');">
         		<tr>
